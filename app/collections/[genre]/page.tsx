...
import { SITE_NAME, DEFAULT_OG_IMAGE, absoluteUrl } from "@/app/lib/site";
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      siteName: SITE_NAME,
      images: [{ url: DEFAULT_OG_IMAGE, width: 1200, height: 630, alt: `${genre.name} collection` }],
      type: "website",
      locale: "en_US",
    },
    twitter: {
...
export default async function GenreCollectionPage({
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: genre.name, item: absoluteUrl(`/collections/${genre.slug}`) },
    ],
  };
